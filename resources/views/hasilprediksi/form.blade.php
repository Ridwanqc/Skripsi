...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small> </h2></div>
	...
	{!! Form::open(array('url'=>'hasilprediksi?return='.$return, 'class'=>'form-horizontal validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="p-5">
		...
		<div class="row">
	<div class="col-md-12">
						<fieldset><legend> Hasil Prediksi</legend>
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='id_karyawan' id='id_karyawan' value='{{ $row['id_karyawan'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='tgl_pengajuan' id='tgl_pengajuan' value='{{ $row['tgl_pengajuan'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group row  " >
										<label for="Angsuran" class=" control-label col-md-4 text-left"> Angsuran </label>
										<div class="col-md-6">
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Jenis Jaminan" class=" control-label col-md-4 text-left"> Jenis Jaminan </label>
										<div class="col-md-6">
										  <textarea name='jenis_jaminan' rows='5' id='jenis_jaminan' class='form-control form-control-sm '  
				           >{{ $row['jenis_jaminan'] }}</textarea> 
										 </div> 
										 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("hasilprediksi/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
