...
class HasilprediksiController extends Controller {
	...
	public $module = 'hasilprediksi';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Hasilprediksi();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'hasilprediksi',
	...
	public static function display(  )
	{
		...
		$model  = new Hasilprediksi();
		$info = $model::makeInfo('hasilprediksi');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('hasilprediksi.public.view',$data);			
			}			
		} 
		else {
			...
			return view('hasilprediksi.public.index',$data);	
		}
