	...
	public function destroy( $request)
	{
		...
		if(is_array($request->input('ids')))
		{
			foreach($request->input('ids') as $r){
				$cek = DB::table('tb_manger')->select('username')->where('id',$r)->pluck('username')->first();
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('manager.public.view',$data);			
			}			
		} 
		else {
			...
			return view('manager.public.index',$data);	
		}
